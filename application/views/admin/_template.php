...
<ul class="shortcut-buttons-set">
	<li><a class="shortcut-button" href="<?PHP echo base_url(); ?>admin/product"><span><img src="<?PHP echo $media_url;?>admin/images/icons/64x64/product_64.png" alt="icon" /><br />Products</span></a></li>
    <li><a class="shortcut-button" href="<?PHP echo base_url(); ?>admin/team"><span><img src="<?PHP echo $media_url;?>admin/images/icons/64x64/team_64.png" alt="icon" /><br />Teams</span></a></li>
    <li><a class="shortcut-button" href="<?PHP echo base_url(); ?>admin/video"><span><img src="<?PHP echo $media_url;?>admin/images/icons/64x64/video_64.png" alt="icon" /><br />Videos</span></a></li>
    <li><a class="shortcut-button" href="<?PHP echo base_url(); ?>admin/statistics"><span><img src="<?PHP echo $media_url;?>admin/images/icons/64x64/statistics_64.png" alt="icon" /><br />Statistics</span></a></li>
    <li><a class="shortcut-button" href="<?PHP echo base_url(); ?>admin/settings"><span><img src="<?PHP echo $media_url;?>admin/images/icons/64x64/settings_64.png" alt="icon" /><br />Settings</span></a></li>
</ul>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a href="#" title="Edit"><img src="<?PHP echo $media_url;?>admin/images/icons/pencil.png" alt="Edit" /></a>
                            <a href="#" title="Delete"><img src="<?PHP echo $media_url;?>admin/images/icons/cross.png" alt="Delete" /></a> 
                            <a href="#" title="Edit Meta"><img src="<?PHP echo $media_url;?>admin/images/icons/hammer_screwdriver.png" alt="Edit Meta" /></a>
                        </td>
                    </tr>
...
<script type="text/javascript" src="<?PHP echo $media_url;?>admin/js/flot/jquery.flot.min.js"></script>
<script type="text/javascript" src="<?PHP echo $media_url;?>admin/js/flot/jquery.flot.crosshair.min.js"></script>

<!--[if IE]>
<script type="text/javascript" language="javascript" src="<?PHP echo $media_url;?>admin/js/flot/excanvas.min.js"></script>
<![endif]-->
