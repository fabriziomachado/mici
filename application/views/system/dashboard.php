...
<ul class="shortcut-buttons-set">
    ...
    <li><a class="shortcut-button" href="<?PHP echo base_url(); ?>system/logs/php" title="PHP Error Logs" style="position: relative;"><span><img src="<?PHP echo $media_url;?>system/images/icons/64x64/page.png" alt="icon" /><br />Error Logs</span><?PHP if($errorfiles > 0): ?><span id="alerts" title="There are <?PHP echo $errorfiles; ?> PHP Error Log Files!"><?PHP echo $errorfiles; ?></span><?PHP endif; ?></a></li>
    <li><a class="shortcut-button" href="<?PHP echo base_url(); ?>system/settings/flushcache" title="Settings"><span><img src="<?PHP echo $media_url;?>system/images/icons/64x64/process.png" alt="icon" /><br />Settings</span></a></li>
</ul>
