...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>System Admin | Sign In</title>
    ...
    <body id="logindiv">
        ...
        <div id="manifest">
            <a href="http://www.manifestinteractive.com" target="_blank" style="color: #666;" title="Visit Manifest Interactive, LLC">&#169; Copyright <?PHP echo date('Y'); ?> Manifest Interactive, LLC &nbsp;&middot;&nbsp; All Rights Reserved</a>
        </div>
        <script type="text/javascript">
