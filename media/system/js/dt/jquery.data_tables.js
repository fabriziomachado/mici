...
(function($, window, document) {
	     ...
	     *           node:nPaging - the DIV which contains this pagination control
            ...
            "fnUpdate": function ( oSettings, fnCallbackDraw )
            {
                ...
                for ( i=iStartButton ; i<=iEndButton ; i++ )
                {
                    if ( iCurrentPage != i )
                    {
                        sList += '<span class="'+oClasses.sPageButton+'" title="Go to Page '+i+'">'+i+'</span>';
                    }
                    else
                    {
                        sList += '<span class="'+oClasses.sPageButtonActive+'" title="Go to Page '+i+'">'+i+'</span>';
                    }
                }

                if (iEndButton == 1 )
                {
                    $('.paging_full_numbers').fadeOut();
                }
                else
                {
                    $('.paging_full_numbers').fadeIn();
                }
                ...
                for ( i=0, iLen=an.length ; i<iLen ; i++ )
                {
                    ...
                    if ( iCurrentPage == 1 )
                    {
                        ...
                        anStatic[0].setAttribute( 'title', '' );
                        anStatic[1].setAttribute( 'title', '' );
                    }
                    else
                    {
                        anStatic[0].className += " "+oClasses.sPageButton;
                        anStatic[1].className += " "+oClasses.sPageButton;
                        anStatic[0].setAttribute( 'title', 'Go to First Page' );
                        anStatic[1].setAttribute( 'title', 'Go to Previous Page' );
                    }
                    ...
                    if ( iPages === 0 || iCurrentPage == iPages || oSettings._iDisplayLength == -1 )
                    {
                        ...
                        anStatic[2].setAttribute( 'title', '' );
                        anStatic[3].setAttribute( 'title', '' );
                    }
                    else
                    {
                        anStatic[2].className += " "+oClasses.sPageButton;
                        anStatic[3].className += " "+oClasses.sPageButton;
                        anStatic[2].setAttribute( 'title', 'Go to Next Page' );
                        anStatic[3].setAttribute( 'title', 'Go to Last Page' );
                    }
                }
            }
        }
    ...
    $.fn.dataTable = function( oInit )
    {
        ...
        function _fnFeatureHtmlLength ( oSettings )
        {
            ...
            var sName = (oSettings.sTableId === "") ? "" : 'name="'+oSettings.sTableId+'_length" id="'+oSettings.sTableId+'_length_select"';
